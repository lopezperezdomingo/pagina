  ...
  <div class="divider"><span></span></div>
        <body>
            ...
            <section>
                <div class="container">
                    <h2>Artículo 74</h2>
                    <h3>Fracción XLV.-Cuadro general de clasificación archivística el catálogo de disposición documental el catálogo de series</h3>
                    <br><br><hr style="margin-top: -25px; border-style: double; border-color: #800080;">
                    <div id="dvVista">
                        <h4><span data-tooltip="Anual, la información del ejercicio en curso">Catálogo de disposición documental y guía simple de archivos</span></h4><h5><i class="fas fa-arrow-alt-circle-right"></i> Año: 2018</h5>
                            <table class="tab-lista" align="center" width="80%">
                                        ...
                                        <tr>
                                            ...
                                            <td><a target="_blank" href="documentos/45/1trimestre.xls"><img src="images/excel.png" style="width: 30px;"></a></td>                                        </tr>
                                                                        </tbody>
                                </table>
