...
<div class="divider"><span></span></div>
  <div class="divider"><span></span></div>
    ...
    <div class="container">
                    <h2>Artículo 74</h2>
                    <h3>Fracción XXVII.-Las concesiones contratos convenios permisos licencias o autorizaciones otorgadas</h3>
                    <br><br><hr style="margin-top: -25px; border-style: double; border-color: #800080;">
                    <div id="dvVista">
                        <h4><span data-tooltip="Trimestral, la información del ejercicio en curso y la correspondiente a los dos ejercicios anteriores">Las concesiones, contratos, convenios, permisos, licencias o autorizaciones otorgados</span></h4><h5><i class="fas fa-arrow-alt-circle-right"></i> Año: 2018</h5>
                            <table class="tab-lista" align="center" width="80%">
                                        ...
                                        <tr>
                                            ...
                                            <td><a target="_blank" href="documentos/27/1trimestre.xlsx"><img src="images/excel.png" style="width: 30px;"></a></td><td><a target="_blank" href="documentos/27/2trimestre.xlsx"><img src="images/excel.png" style="width: 30px;"></a></td><td><a target="_blank" href="documentos/27/3trimestre.xlsx"><img src="images/excel.png" style="width: 30px;"></a></td><td></td>                                        </tr>
                                                                        </tbody>
                                </table>
