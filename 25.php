  ...
  <div class="divider"><span></span></div>
        <body>
            ...
            <section>
                <div class="container">
                    <h2>Artículo 74</h2>
                    <h3>Fracción XXV.-El resultado de la dictaminación de los estados financieros</h3>
                    <br><br><hr style="margin-top: -25px; border-style: double; border-color: #800080;">
                    <div id="dvVista">
                        <h4><span data-tooltip="Anual, la información de los dos ejercicios anteriores">Resultados de la dictaminación de los estados financieros</span></h4><h5><i class="fas fa-arrow-alt-circle-right"></i> Año: 2018</h5>
                                        ...
                                        <tr>
                                            ...
                                            <th>Anual</th>                                        </tr>
                                                                ...
                                                                <tbody>
                                                                            <tr>
                                            <td>Tesorería</td>
                                            <td><a target="_blank" href="documentos/25/1trimestre.xlsx"><img src="images/excel.png" style="width: 30px;"></a></td>                                        </tr>
                                                                        </tbody>
                                </table>
