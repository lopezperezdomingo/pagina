    ...
    <div class="tp-banner-container">
		<div class="tp-banner tp-banner-full-width" >
			<ul>
                ...
                <!-- SLIDE  -->
				<li data-transition="fade" data-slotamount="7" data-masterspeed="10" >
                ...
                <!-- SLIDE  -->
				<li data-transition="fade" data-slotamount="7" data-masterspeed="10" >
					<img src="img/rev-slider/4/slide4.jpg" style='background-color:#b2c4cc' alt=""  data-bgfit="cover" data-bgposition="center top" data-bgrepeat="no-repeat">
				</li>
                <!-- SLIDE  -->

                <!-- SLIDE  -->
				<li data-transition="fade" data-slotamount="7" data-masterspeed="10" >
					<img src="img/rev-slider/5/slide5.jpg" style='background-color:#b2c4cc' alt=""  data-bgfit="cover" data-bgposition="center top" data-bgrepeat="no-repeat">
				</li>
                <!-- SLIDE  -->
