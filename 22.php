  ...
  <div class="divider"><span></span></div>
        <body>
            ...
            <section>
                <div class="container">
                    <h2>Artículo 74</h2>
                    <h3>Fracción XXII.-Información relativa a la deuda pública</h3>
                    <br><br><hr style="margin-top: -25px; border-style: double; border-color: #800080;">
                    <div id="dvVista">
                        <h4><span data-tooltip="Trimestral, la información del ejercicio en curso y la correspondiente a los dos ejercicios anteriores">Deuda pública</span></h4><h5><i class="fas fa-arrow-alt-circle-right"></i> Año: 2018</h5>
                                        ...
                                        <tr>
                                            ...
                                            <th>Trimestre 1</th><th>Trimestre 2</th><th>Trimestre 3</th><th>Trimestre 4</th>                                        </tr>
                                                                ...
                                                                <tbody>
                                                                            <tr>
                                            <td>Tesorería</td>
                                            <td><a target="_blank" href="documentos/22/1trimestre.xlsx"><img src="images/excel.png" style="width: 30px;"></a></td><td><a target="_blank" href="documentos/22/2trimestre.xlsx"><img src="images/excel.png" style="width: 30px;"></a></td><td><a target="_blank" href="documentos/22/3trimestre.xlsx"><img src="images/excel.png" style="width: 30px;"></a></td><td></td>                                        </tr>
                                                                        </tbody>
                                </table>
