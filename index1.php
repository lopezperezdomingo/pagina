  ...
  <div class="divider"><span></span></div>
        <body>
            ...
            <section>
                <div class="container">
                    <h2>Artículo 78</h3>
                    <h3>Fracción I.-Planes municipales</h4>
                    <br><br><hr style="margin-top: -25px; border-style: double; border-color: #800080;">
                    <div id="dvVista">
                        <h4><span data-tooltip="Anual, información del año en curso">A) Hipervínculo al Plan Nacional de Desarrollo</span></h4><h5><i class="fas fa-arrow-alt-circle-right"></i> Año: 2018</h5>
                            <table class="tab-lista" align="center" width="80%">
                                        ...
                                        <tr>
                                            ...
                                            <td><a target="_blank" href="documentos/781/1trimestre.xlsx"><img src="images/excel.png" style="width: 30px;"></a></td>                                        </tr>
                                                                        </tbody>
                                </table>

                        <h4><span data-tooltip="Anual, la información del ejercicio en curso y la correspondiente a los dos ejercicios anteriores">B) Plan de Desarrollo</span></h4><h5><i class="fas fa-arrow-alt-circle-right"></i> Año: 2018</h5>
                            <table class="tab-lista" align="center" width="80%">
                                                                <thead>
                                        <tr>
                                            <th>DEPENDENCIA / ENTIDAD</th>
                                            <th>Anual</th>                                        </tr>
                                                                ...
                                                                <tbody>
                                                                            <tr>
                                            <td>Secretaría de planeación</td>
                                            <td><a target="_blank" href="documentos/781/2trimestre.xlsx"><img src="images/excel.png" style="width: 30px;"></a></td>                                        </tr>
                                                                        </tbody>
                                </table>
