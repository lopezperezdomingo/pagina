  ...
  <div class="divider"><span></span></div>
        <body>
            ...
            <section>
                <div class="container">
                    <h2>Artículo 74</h2>
                    <h3>Fracción XXXVI.-Resoluciones y laudos</h3>
                    <br><br><hr style="margin-top: -25px; border-style: double; border-color: #800080;">
                    <div id="dvVista">
                        <h4><span data-tooltip="Trimestral, la información del ejercicio en curso y la correspondiente al ejercicio anterior">Resoluciones y laudos emitidos</span></h4><h5><i class="fas fa-arrow-alt-circle-right"></i> Año: 2018</h5>
                            <table class="tab-lista" align="center" width="80%">
                                        ...
                                        <tr>
                                            ...
                                            <td><a target="_blank" href="documentos/36/1trimestre.xls"><img src="images/excel.png" style="width: 30px;"></a></td><td><a target="_blank" href="documentos/36/2trimestre.xls"><img src="images/excel.png" style="width: 30px;"></a></td><td><a target="_blank" href="documentos/36/3trimestre.xls"><img src="images/excel.png" style="width: 30px;"></a></td><td></td>                                        </tr>
                                                                            <tr>
                                            <td>Secretaría de desarrollo urbano</td>
                                            <td></td><td></td><td><a target="_blank" href="documentos/36/5trimestre.xls"><img src="images/excel.png" style="width: 30px;"></a></td><td></td>                                        </tr>
                                                                        </tbody>
                                </table>

                                                <div style="width: 100%; height: 35px;"></div>
                        <p style="font-weight: bold; font-size: 10pt;">Fuente de la Información: Oficina de presidencia, Secretaría de desarrollo urbano</p>
