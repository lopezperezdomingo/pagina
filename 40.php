  ...
  <div class="divider"><span></span></div>
        <body>
            ...
            <section>
                <div class="container">
                    <h2>Artículo 74</h2>
                    <h3>Fracción XL.-Evaluaciones y encuestas a programas financiados con recursos públicos</h3>
                    <br><br><hr style="margin-top: -25px; border-style: double; border-color: #800080;">
                    <div id="dvVista">
                        <h4><span data-tooltip="Anual, la información del ejercicio en curso y la correspondiente al ejercicio anterior">A) Evaluaciones y encuestas a programas financiados con recursos públicos</span></h4><h5><i class="fas fa-arrow-alt-circle-right"></i> Año: 2018</h5>
                            <table class="tab-lista" align="center" width="80%">
                                        ...
                                        <tr>
                                            ...
                                            <td><a target="_blank" href="documentos/40/1trimestre.xls"><img src="images/excel.png" style="width: 30px;"></a></td>                                        </tr>
                                                                        </tbody>
                                </table>

                        <h4><span data-tooltip="Anual, la información del ejercicio en curso y la correspondiente a los dos ejercicios anteriores">B) Encuestas sobre programas financiados con recursos</span></h4><h5><i class="fas fa-arrow-alt-circle-right"></i> Año: 2018</h5>
                            <table class="tab-lista" align="center" width="80%">
                                                                <thead>
                                        <tr>
                                            <th>DEPENDENCIA / ENTIDAD</th>
                                            <th>Anual</th>                                        </tr>
                                                                ...
                                                                <tbody>
                                                                            <tr>
                                            <td>Secretaría de planeación</td>
                                            <td><a target="_blank" href="documentos/40/2trimestre.xls"><img src="images/excel.png" style="width: 30px;"></a></td>                                        </tr>
                                                                        </tbody>
                                </table>

                                                <div style="width: 100%; height: 35px;"></div>
                        <p style="font-weight: bold; font-size: 10pt;">Fuente de la Información: Secretaría de planeación</p>
